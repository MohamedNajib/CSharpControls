...
namespace WindowsControls.CustomControls
{
    public class MenuRenderer : ToolStripProfessionalRenderer
    {
        ...
        //Constructor
        public MenuRenderer(bool isMainMenu, Color primaryColor, Color textColor, Color leftColumnColor, Color backGroundColor)
            : base(new MenuColorTable(isMainMenu, primaryColor, leftColumnColor, backGroundColor))
        {
