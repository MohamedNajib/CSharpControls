...
namespace WindowsControls.CustomControls
{
    public class MenuColorTable : ProfessionalColorTable
    {
        ...
        //Constructor
        //Constructor
        public MenuColorTable(bool isMainMenu, Color primaryColor, Color lColumnColor, Color backGroundColor)
        {
            if (isMainMenu)
            {
                backColor = backGroundColor == Color.Empty ? Color.FromArgb(37, 39, 60) : backGroundColor;
                leftColumnColor = lColumnColor == Color.Empty ? Color.FromArgb(32, 33, 51) : lColumnColor;
            ...
            {
                backColor = backGroundColor == Color.Empty ? Color.White : backGroundColor;
                leftColumnColor = lColumnColor == Color.Empty ? Color.LightGray : lColumnColor;
